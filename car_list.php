              ...
              <div class="col-md-9 col-md-push-3">
                <div class="result-sorting-wrapper">
                  <div class="sorting-count">
                    ...
                    $sql = "SELECT id from registeredcars";
                    
                    $results=mysqli_query($db,$sql);
                    
                    $cnt=mysqli_insert_id($db);
                    ?>
                    <p><span><?php echo htmlentities($cnt);?> Listings</span></p>
                  </div>
                </div>

                <?php $sql = "SELECT registeredcars.*,brands.brand_name,brands.id as bid  from registeredcars join brands on brands.id=registeredcars.brandId order by rand() ";
                ...
                if(mysqli_num_rows($results) > 0)
                {
                  ...
                  {  
                    ...
                    <div class="product-listing-m gray-bg">
                      <div class="product-listing-img"><img src="<?php echo htmlentities($result['imageOne']);?>" class="img-responsive" alt="Image" style="height: 150px; width:300px;" /> </a> 
                      </div>
