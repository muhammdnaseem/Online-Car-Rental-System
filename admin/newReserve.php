...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header text-danger h3">New Reserve</div>
            <div class="card-body p-3">
                <div class="table-responsive">
                <table class="table" id="newBookingTable">
                    <thead>
                        <tr>
                            <th>Reserve#</th>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        foreach($newReserve as $reserve):
                            if($reserve['reserveStatus'] == 'notConfirm'):
                        ?>
                        <tr>
                          ...
                          <td><?= $reserve['username']; ?></td>
                           ...
                           <td><?= $reserve['fromLocation'] . ' ' . $reserve['selectfromlocation']; ?></td>
                            ...
                            <td><span class="badge badge-info badge-pill">Not confirmed yet</span></td>
